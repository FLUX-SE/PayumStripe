...
use ArrayObject;
use FluxSE\PayumStripe\Action\CancelPaymentIntentAction;
...
final class CancelPaymentIntentActionTest extends TestCase
{
    use GatewayAwareTestTrait;

    public function testShouldImplements(): void
    {
        $action = new CancelPaymentIntentAction();
    ...
    public function testShouldSupportOnlyCancelWithAnArrayAccessModelWithCaptureMethodManual(): void
    {
        ...
        $this->assertTrue($action->supports(new Cancel(['object' => PaymentIntent::OBJECT_NAME, 'capture_method' => 'manual'])));
        $this->assertFalse($action->supports(new Cancel(['capture_method' => 'manual'])));
        $this->assertFalse($action->supports(new Cancel(['object' => PaymentIntent::OBJECT_NAME, 'capture_method' => 'automatic'])));
        $this->assertFalse($action->supports(new Cancel(['capture_method' => 'automatic'])));
        $this->assertFalse($action->supports(new Cancel(['object' => PaymentIntent::OBJECT_NAME])));
        ...
        $this->assertFalse($action->supports(new Authorize(['object' => PaymentIntent::OBJECT_NAME, 'capture_method' => 'manual'])));
    }
